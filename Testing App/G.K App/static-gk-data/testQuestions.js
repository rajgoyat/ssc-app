...
const testQuestions2 = [
  ...
  { id: 'static-history-002', mainCategory: "Test Questions", testSet: "Test 2", category: 'Modern History', question: 'With reference to Ishwar Chandra Vidyasagar, which statements are correct? I. He protested against child marriage and polygamy. II. His efforts contributed to the Hindu Widows\' Remarriage Act, 1856. III. He was primarily known for his scholarship in Persian.', options: ['I, II and III', 'I and II only', 'I and III only', 'II and III only'], answer: 1, explanation: "1336 → Harihara & Bukka → Vijayanagara → Hampi → Tungabhadra → Sangama Dynasty"},
